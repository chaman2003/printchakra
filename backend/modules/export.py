...
class ExportModule:
    ...
    def resize_to_page(
        ...
        if len(image.shape) == 3:
            canvas = (
                np.ones(
                    (target_height + 2 * padding, target_width + 2 * padding, 3), dtype=np.uint8
                )
                * 255
            )
        else:
            canvas = (
                np.ones((target_height + 2 * padding, target_width + 2 * padding), dtype=np.uint8)
                * 255
            )
    ...
    def export_to_pdf_reportlab(
        self, images: List[str], output_path: str, page_size: str = "A4"
    ) -> bool:
        """
    ...
    def export_to_pdf(
        self, images: List[str], output_path: str, method: str = "auto", page_size: str = "A4"
    ) -> bool:
        """
    ...
    def create_print_ready_image(
        self, image_path: str, output_path: str, page_size: str = "A4", dpi: int = 300
    ) -> bool:
        """
