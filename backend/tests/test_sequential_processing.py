...
def create_test_image(width=800, height=600, add_text=False):
    ...
    if add_text:
        cv2.putText(image, "TEST DOCUMENT", (100, 150), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 0), 2)
        cv2.putText(
            image, "Invoice #123456", (100, 250), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 0), 2
        )
        cv2.putText(
            image, "Amount: $100.00", (100, 350), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0), 2
        )
