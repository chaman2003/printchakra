...
const Dashboard: React.FC = () => {
  ...
  const surfaceCard = useColorModeValue('rgba(255, 255, 255, 0.92)', 'rgba(14, 18, 32, 0.96)');
  const dockedChatBg = useColorModeValue('rgba(248, 250, 255, 0.95)', 'rgba(9, 14, 26, 0.96)');
  const dockedBorderColor = useColorModeValue('rgba(0,0,0,0.06)', 'rgba(255,255,255,0.06)');
                  ...
                  <SimpleGrid columns={{ base: 2, md: 3, xl: 4 }} spacing={3} mb={2}>
                    {folders.map(folder => (
                      <Card
                        ...
                        borderRadius="xl"
                        cursor="pointer"
                        boxShadow={useColorModeValue('0 1px 3px rgba(0,0,0,0.04)', 'none')}
                        _hover={{ borderColor: useColorModeValue('rgba(0,0,0,0.15)', 'rgba(255,255,255,0.15)'), transform: 'translateY(-1px)', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}
                        transition="all 0.2s"
                    ...
                    {files.map((file: FileInfo, index: number) => {
                      ...
                      return (
                        <MotionCard
                          ...
                          borderRadius="2xl"
                          border="1px solid"
                          borderColor={isSelected ? 'green.400' : useColorModeValue('rgba(0,0,0,0.06)', 'rgba(255,255,255,0.06)')}
                          boxShadow={isSelected ? '0 0 0 1px var(--chakra-colors-green-400), 0 4px 12px rgba(72,187,120,0.2)' : useColorModeValue('0 1px 3px rgba(0,0,0,0.04)', 'none')}
                          bg={surfaceCard}
                          position="relative"
                          overflow="hidden"
                          ...
                          _hover={{
                            boxShadow: isSelected
                              ? '0 0 0 1px var(--chakra-colors-green-400), 0 8px 24px rgba(72,187,120,0.3)'
                              : useColorModeValue('0 8px 24px rgba(0,0,0,0.08)', '0 8px 24px rgba(0,0,0,0.3)'),
                            borderColor: isSelected ? 'green.400' : useColorModeValue('rgba(0,0,0,0.15)', 'rgba(255,255,255,0.15)'),
                          }}
